...
<html lang="en">
  ...
  <body style = "background-color:#8888">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a class="btn btn-warning" href="editar.php?id=<?=$id?>"><i class='bx bx-message-alt-edit'></i></a>
        <a class="btn btn-danger" href="acciones/eliminar.php?id=<?=$id?>"><i class='bx bx-trash'></i></a>
      </td>
    </tr>
    <?php
      }
